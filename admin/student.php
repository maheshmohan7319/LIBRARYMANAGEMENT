                                        ...
                                        while($row = $result->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="student.php?delete=<?php echo htmlspecialchars($row['user_id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
